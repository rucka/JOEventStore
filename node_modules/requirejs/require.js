...
(function (global) {
    var req, s, head, baseElement, dataMain, src,
        ...
        isWebWireUp = !isBrowser && typeof importScripts !== 'undefined',
    ...
    function newContext(contextName) {
        ...
        function checkLoaded() {
            ...
            if ((!expired || usingPathFallback) && stillLoading) {
                ...
                if ((isBrowser || isWebWireUp) && !checkLoadedTimeoutId) {
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            //In a web WireUp, use importScripts. This is not a very
            //efficient use of importScripts, importScripts will block until
            //its script is downloaded and evaluated. However, if web WireUps
